        ...
        <div className="mb-12">
          <div className="relative inline-block">
            ...
            <div className="flex items-end mb-1 ml-5">
              <span className="text-[25px] font-normal tracking-tight pt-1">
                yayasan
              </span>
              <span className="text-[40px] font-extrabold tracking-tight leading-none ml-2">
                ASTRA
              </span>
            </div>
            ...
            <div className="flex items-baseline gap-2 mt-[-4px]">
              ...
              <div className="flex items-center">
                <div className="h-[2px] w-[280px] bg-white"></div>
